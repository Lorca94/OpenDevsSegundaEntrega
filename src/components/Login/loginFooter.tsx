import { Text, Box, Flex, Link, Spacer } from "@chakra-ui/react";
import React from "react";

export default function LoginFooter() {
    return(
        <Flex marginTop="-25px" flexDirection={["column","row","row"]} alignItems={["center",null,null]} justifyContent="center">
